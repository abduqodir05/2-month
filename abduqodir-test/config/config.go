...
func Load() Config {
	...
	cfg.PostgresUser = cast.ToString(getOrReturnDefaultValue("POSTGRES_USER", "abduqodir"))
	cfg.PostgresPassword = cast.ToString(getOrReturnDefaultValue("POSTGRES_PASSWORD", "asdf"))
	cfg.PostgresDatabase = cast.ToString(getOrReturnDefaultValue("POSTGRES_DATABASE", "products"))
